...
class Browser(QMainWindow):
        ...
        if did in self.downloads:
            ...
            if success:
                ...
                if info.get('status') != 'cancelled':
                    info['status'] = 'failed'
                QMessageBox.warning(self, "Download Completed", "Download Completed!")
    ...
    def save_link_as(self, url):
        ...
        QMessageBox.information(self, "Download Started", f"File is being downloaded:\n{os.path.basename(fname)}\n\nLocation: {fname}")
    ...
    def cancel_download(self, download_id):
        ...
        if int(download_id) in self.download_widgets:
            try:
                ...
                pass
        QMessageBox.information(self, "Cancel", "Download cancelled.")
